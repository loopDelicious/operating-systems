...
import json from '../data/flare.json';
        ...
        return (
            <div className="width">
                <div className="section">
                    <h2>Market share</h2>
                    <p>This JSON tree provides an alternative view of the above illustrations (same underlying data). Click the arrows on the left to expand and collapse each operating system to view ancestral relationships.</p>
